.. index:: pair\_style body

pair\_style body command
========================
...
point-particles.  See :ref:`Section\_howto 14 <howto_14>`
...
.. warning::
   ...
   In the example just described, all 30 interactions are
...
was built with that package.  See the :ref:`Making LAMMPS with optional packages <start_3>` section for more info.
