...
billions.  See :doc:`Section\_perf <Section_perf>` for information on
...
:doc:`Section\_history <Section_history>` for more information on
...
:doc:`Section\_modify <Section_modify>`, which describes how you can add
it to LAMMPS.
...
* `KIM archive <http://openkim.org>`_ of potentials
...
* :doc:`grand canonical Monte Carlo <fix_gcmc>` insertions/deletions
...
For atomic systems LAMMPS provides a :doc:`create\_atoms <create_atoms>`
...
LAMMPS runs, see :doc:`Section\_modify <Section_modify>` for a discussion
...
discussed in :doc:`Section\_history <Section_history>`.
...
.. _dlpoly: http://www.cse.clrc.ac.uk/msi/software/DL\_POLY
...
Tinker is a serial code.  DL\_POLY includes potentials for a variety of
...
`developers <https://www.lammps.org/authors.html>`_ on any of these
items.
...
* If you find a bug, :ref:`Section\_errors 2 <err_2>`
...
* The tools sub-directory of the LAMMPS distribution has various
  ...
  details are given in :doc:`Section\_tools <Section_tools>`.  If you write
...
under the `Citing LAMMPS link <https://www.lammps.org/cite.html>`_ of
the LAMMPS WWW page.

The `Publications link <https://www.lammps.org/papers.html>`_ on the
...
`Pictures <https://www.lammps.org/pictures.html>`_ or
`Movies <https://www.lammps.org/movies.html>`_ pages of the LAMMPS WWW
site.
...
As discussed in :doc:`Section\_history <Section_history>`, LAMMPS
