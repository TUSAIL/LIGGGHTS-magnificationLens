...
* :doc:`atom/molecule <compute_atom_molecule>` - sum per-atom properties for each molecule
...
* :doc:`com/molecule <compute_com_molecule>` - center-of-mass for each molecule
...
* :doc:`gyration/molecule <compute_gyration_molecule>` - radius of gyration for each molecule
...
* :doc:`inertia/molecule <compute_inertia_molecule>` - inertia tensor for each molecule
...
* :doc:`msd/molecule <compute_msd_molecule>` - mean-squared displacement for each molecule
...
* :doc:`property/molecule <compute_property_molecule>` - convert molecule attributes to localvectors/arrays
