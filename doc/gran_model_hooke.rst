...
.. image:: Eqs/pair_gran_html_147eaf38.png
   :align: center
...
:ref:`(Legendre) <Legendre>`, *viscous* = off performs no modification.

One has to provide the 3 peratomtypepair parameters via a :doc:`fix property/global <fix_property>`
