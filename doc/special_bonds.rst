...
.. warning::
   ...
   Thus LAMMPS ignores special\_bonds settings when manybody potentials
   are calculated.
...
.. warning::
   ...
   For purposes of computing weighted pairwise
...
during a simulation run, e.g. by the :doc:`fix bond/create <fix_bond_create>` command.  A list of 1-2,1-3,1-4
