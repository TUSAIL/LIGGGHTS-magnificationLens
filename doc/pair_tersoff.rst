...
pair\_style tersoff/cuda
========================

pair\_style tersoff/omp
=======================
...
:ref:`(Tersoff\_1) <Tersoff_1>` for the energy E of a system of atoms as
...
Tersoff\_2 :ref:`(Tersoff\_2) <Tersoff_2>` are not symmetric.
...
potential :ref:`(Tersoff\_2) <Tersoff_2>`. The *tersoff/table* style implements
