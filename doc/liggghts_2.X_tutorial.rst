LIGGGHTS 2.X vs. LIGGGHTS - syntax changes
##########################################
...
where *old\_syntax* refers to the syntax used in LIGGGHTS 1.5.3 and before,
and *new\_syntax* refers to the syntax used in LIGGGHTS 2.X
...
.. note::
   ...
   For compatibility reasons, the old syntax can still be used in LIGGGHTS 2.0
...
.. note::
  ...
  * For compatibility reasons, the command name *fix move/mesh/gran* can be used in LIGGGHTS 2.0.
    However, the syntax has to follow the LIGGGHTS 2.0 syntax.
