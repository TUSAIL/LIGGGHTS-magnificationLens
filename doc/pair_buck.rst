...
pair\_style buck/coul/cut/cuda command
======================================
...
pair\_style buck/coul/long/cuda command
=======================================
...
.. warning::
   ...
   For all these pair styles, the terms with A and C are
   ...
   long-range (no cutoff), then see the :doc:`pair\_style buck/long/coul/long <pair_buck_long>` command.
