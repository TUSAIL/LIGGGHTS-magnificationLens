...
.. thumbnail:: img/dump1.jpg

.. thumbnail:: img/dump2.jpg
...
gzip, if LAMMPS has been compiled with -DLAMMPS\_GZIP and a ".gz" suffix
is used.
...
The color of the box boundaries can be set with the :doc:`dump\_modify boxcolor <dump_modify>` command.
