...
:doc:`pair\_style <pair_charmm>` with epsilon and sigma values specified
with a :doc:`pair\_coeff <pair_charmm>` command.  Note that this
...
For CHARMM force fields, the special\_bonds 1-4 weighting factor should
be set to 0.0.  This is because the pair styles that contain "charmm"
(e.g. :doc:`pair\_style lj/charmm/coul/long <pair_charmm>`) define extra
...
do not set the special\_bonds 1-4 weighting factor to 0.0 (which is the
...
For AMBER force fields, the special\_bonds 1-4 weighting factor should
