...
* 12.1 :ref:`Building LAMMPS as a shared library <py_1>`
* 12.2 :ref:`Installing the Python wrapper into Python <py_2>`
* 12.3 :ref:`Extending Python with MPI to run in parallel <py_3>`
* 12.4 :ref:`Testing the Python-LAMMPS interface <py_4>`
* 12.5 :ref:`Using LAMMPS from Python <py_5>`
* 12.6 :ref:`Example Python scripts that use LAMMPS <py_6>`
...
how to build LAMMPS as a library, and :ref:`Section\_howto 19 <howto_19>` for a description of the library
...
This can easily extend the Python interface as well.  See details
below.
...
time as LAMMPS runs.  Examples of such scripts are included in the
python directory.
...
If an error occurs, carefully go through the steps in :ref:`Section\_start 5 <start_5>` and above about building a shared
...
See :ref:`Section\_howto 15 <howto_15>` of the manual for a
...
of the atom coords stored internally in LAMMPS, whereas extract\_atom()
...
.. thumbnail:: img/screenshot_gl.jpg

.. thumbnail:: img/screenshot_atomeye.jpg

.. thumbnail:: img/screenshot_pymol.jpg

.. thumbnail:: img/screenshot_vmd.jpg
