...
:doc:`pairwise <pair_style>` bond-order potential such as Tersoff or
...
.. warning::
   ...
   To create a new bond, the internal LAMMPS data
...
.. warning::
   ...
   LAMMPS also maintains a data structure that stores a
