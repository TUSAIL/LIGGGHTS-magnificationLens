...
Four quantities are calculated by this compute for each molecule.  The
...
is used to calculate its initial and current position.
...
.. warning::
   ...
   this compute does not store the initial center-of-mass coordinates of
...
global array values from a compute as input.  See :ref:`this section <howto_15>` for an overview of LAMMPS output
options.
