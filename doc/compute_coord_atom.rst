...
with same atom type are counted. The latter can be useful to quantify
...
per-atom values from a compute as input.  See :ref:`Section\_howto 15 <howto_15>` for an overview of LAMMPS output
options.
