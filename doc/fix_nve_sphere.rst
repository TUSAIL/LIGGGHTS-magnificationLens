...
* keyword = *update* or *implicit\_integration*
  
  .. parsed-literal::
  
       *update* value = *dipole*
         dipole = update orientation of dipole moment during integration
       *implicit_integration* value = *yes* or *no*
...
*implicit\_integration* (default *no*\ ) treats the drag force in a coupled simulation implicitly
