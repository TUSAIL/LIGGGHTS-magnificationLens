...
.. warning::
   ...
   Even though the EIM potential is treating atoms as
   charged ions, you should not use a LAMMPS :doc:`atom\_style <atom_style>`
   ...
   equation above for q\_i; you do not assign charges explicitly.
