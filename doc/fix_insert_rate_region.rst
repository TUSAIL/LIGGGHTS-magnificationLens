...
* general\_keywords = *verbose* or *maxattampt* or *nparticles* or *mass* or *particlerate* or *massrate* or *insert\_every* or *overlapcheck* or *all\_in* or *random\_distribute* or *vel constant* or *vel uniform* or *vel gaussian* or *orientation* or *omega*
...
* rate\_region keywords = *region* or *ntry\_mc*
...
:doc:`fix insert/stream <fix_insert_stream>`, :doc:`fix insert/pack <fix_insert_pack>`,
:doc:`fix deposit <fix_deposit>`, :doc:`fix gravity <fix_gravity>`,
:doc:`region <region>`, :doc:`fix pour/legacy <fix_pour>`
