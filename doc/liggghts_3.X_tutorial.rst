LIGGGHTS 3.X vs. LIGGGHTS 2.X - syntax changes
##############################################

Introduction:
*************

This is a short outline of the most important changes in LIGGGHTS 3.X 
...
where *old\_syntax* refers to the syntax used in LIGGGHTS 2.X and before,
and *new\_syntax* refers to the syntax used in LIGGGHTS 3.X.
