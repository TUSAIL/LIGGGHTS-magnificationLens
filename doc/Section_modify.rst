...
| 11.1 :ref:`Atom styles <mod_1>`
| 11.2 :ref:`Bond, angle, dihedral, improper potentials <mod_2>`
| 11.3 :ref:`Compute styles <mod_3>`
| 11.4 :ref:`Dump styles <mod_4>`
| 11.5 :ref:`Dump custom output options <mod_5>`
| 11.6 :ref:`Fix styles <mod_6>` which include integrators,      temperature and pressure control, force constraints,      boundary conditions, diagnostic output, etc
| 11.7 `Input script commands <mod_7>`_
| 11.8 :ref:`Kspace computations <mod_8>`
| 11.9 :ref:`Minimization styles <mod_9>`
| 11.10 :ref:`Pairwise potentials <mod_10>`
| 11.11 :ref:`Region styles <mod_11>`
| 11.12 :ref:`Body styles <mod_12>`
| 11.13 :ref:`Thermodynamic output options <mod_13>`
| 11.14 :ref:`Variable options <mod_14>`
| 11.15 :ref:`Submitting new features for inclusion in LAMMPS <mod_15>`
|
...
* If you add something you think is truly useful and doesn't impact
  ...
  `developers <https://www.lammps.org/authors.html>`_.  We might be
...
The "name" of a custom attribute, as specified in the :doc:`fix property/atom <fix_property>` command, is checked to verify
...
+-------------------+------------------------------------------------------------------+
| surface\_interior | determine if a point is within a cutoff distance inside of surf  |
+-------------------+------------------------------------------------------------------+
| surface\_exterior | determine if a point is within a cutoff distance outside of surf |
+-------------------+------------------------------------------------------------------+
...
See :ref:`Section\_howto 14 <howto_14>` of the manual for
...
`the developers <https://www.lammps.org/authors.html>`_, especially if
...
of a :ref:`standard package <start_3>`.  Else we will add
...
non-trivial changes in core LAMMPS files, you'll need to `communicate with the developers <https://www.lammps.org/authors.html>`_, since we
...
* If your contribution is several related features, it is probably best
...
* Your new source files need to have the LAMMPS copyright, GPL notice,
  ...
  that would be nice.
* Finally, you **must** also create a **documentation** file for each new command
