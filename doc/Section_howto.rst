...
| 7.1 :ref:`Restarting a simulation <howto_1>`
| 7.2 :ref:`2d simulations <howto_2>`
| 7.3 :ref:`CHARMM, AMBER, and DREIDING force fields <howto_3>`
| 7.4 :ref:`Running multiple simulations from one input script <howto_4>`
| 7.5 :ref:`Multi-replica simulations <howto_5>`
| 7.6 :ref:`Granular models <howto_6>`
| 7.7 :ref:`TIP3P water model <howto_7>`
| 7.8 :ref:`TIP4P water model <howto_8>`
| 7.9 :ref:`SPC water model <howto_9>`
| 7.10 :ref:`Coupling LAMMPS to other codes <howto_10>`
| 7.11 :ref:`Visualizing LAMMPS snapshots <howto_11>`
| 7.12 :ref:`Triclinic (non-orthogonal) simulation boxes <howto_12>`
| 7.13 :ref:`NEMD simulations <howto_13>`
| 7.14 :ref:`Finite-size spherical and aspherical particles <howto_14>`
| 7.15 :ref:`Output from LAMMPS (thermo, dumps, computes, fixes, variables) <howto_15>`
| 7.16 :ref:`Thermostatting, barostatting and computing temperature <howto_16>`
| 7.17 :ref:`Walls <howto_17>`
| 7.18 :ref:`Elastic constants <howto_18>`
| 7.19 :ref:`Library interface to LAMMPS <howto_19>`
| 7.20 :ref:`Calculating thermal conductivity <howto_20>`
| 7.21 :ref:`Calculating viscosity <howto_21>` 
| 
...
.. warning::
   ...
   Some models in LAMMPS treat particles as finite-size
...
:doc:`read\_data <read_data>` command or in the input script with
commands like :doc:`pair\_coeff <pair_coeff>` or
:doc:`bond\_coeff <bond_coeff>`.  See :doc:`Section\_tools <Section_tools>`
...
to LAMMPS.  See :ref:`Section\_howto 19 <howto_19>` of the
...
:doc:`Section\_tools <Section_tools>` doc page for details.  The first is
...
A second use is to run Parinello-Rahman dynamics via the :doc:`fix npt <fix_nh>` command, which will adjust the xy, xz, yz tilt
...
* :doc:`pair\_style body <pair_body>`
...
particles are computed via a command like :doc:`pair\_style body <pair_body>`.
...
Every :doc:`variable <variable>` defined in an input script generates
...
All but the first 3 calculate velocity biases (e.g. advection
...
it in conjunction with :doc:`compute temp/partial <compute_temp_partial>`.

.. warning::

   Only the nvt fixes perform time integration, meaning
...
.. warning::
   ...
   As with the thermostats, the Nose/Hoover methods (:doc:`fix npt <fix_nh>` and :doc:`fix nph <fix_nh>`) perform time
   integration.  :doc:`Fix press/berendsen <fix_press_berendsen>` does NOT,
...
:doc:`thermo\_style <thermo_style>` command, the default T and P are
...
explicitly via a :doc:`thermo\_style custom <thermo_style>` command.  Or
you can use the :doc:`thermo\_modify <thermo_modify>` command to
...
As described in :ref:`Section\_start 5 <start_5>`, LAMMPS
...
through the library interface to setup a problem and then run it,
