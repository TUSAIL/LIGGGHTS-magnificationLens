...
:ref:`(Tersoff\_1) <Tersoff_1>` with a close-separation pairwise modification
...
Tersoff\_2 potential :ref:`(Tersoff\_2) <Tersoff_2>`.

LAMMPS parameter values for Tersoff\_2 can be obtained as follows:
gamma = 1, just as for Tersoff\_1, but now lambda3 = 0 and the value of
...
**(Tersoff\_2)** J. Tersoff, Phys Rev B, 39, 5566 (1989)
