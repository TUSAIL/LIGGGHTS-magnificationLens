...
specified by :doc:`pair\_style reax/c <pair_reax_c>`.  Bond-order values 
...
as specified using the :doc:`reax/c pair\_coeff <pair_reax_c>` command and 
...
:doc:`pair\_style reax/c <pair_reax_c>` and it requires that the :doc:`pair\_style reax/c <pair_reax_c>` be invoked.  This fix is part of the
...
:doc:`pair\_style reax/c <pair_reax_c>`, :doc:`fix reax/bonds <fix_reax_bonds>`
