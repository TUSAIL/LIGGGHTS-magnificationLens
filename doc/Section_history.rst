...
| 14.1 :ref:`Coming attractions <hist_1>`
| 14.2 :ref:`Past versions <hist_2>`
|
...
The `Wish list link <https://www.lammps.org/future.html>`_ on the
...
You can also send `email to the developers <https://www.lammps.org/authors.html>`_ if you want to add
...
The `History link <https://www.lammps.org/history.html>`_ on the
