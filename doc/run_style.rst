...
processors.  See :ref:`Section\_start 6 <start_7>` for an
...
switches"Section\_start.html#start\_7 to change this.  The log and
...
:doc:`Section\_accelerate <Section_accelerate>` of the manual.
...
REPLICA package.  See the :ref:`Making LAMMPS <start_3>`
