...
partitions remain idle. See :ref:`Section\_howto 5 <howto_5>` of the manual for further discussion of
...
algorithm has been defined by the *min* and *min\_style* keywords or
...
The NEB statistics are written to the file specified by the *neb\_log*
...
10, *min\_style* = *cg*\ , *neb\_style* = *quickmin*\ , and *neb\_log* =
"none"
