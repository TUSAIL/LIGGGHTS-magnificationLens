...
* keyword = *contact\_area* or *area\_correction*
...
Using keyword *contact\_area*, you can choose from 3 modes of calculating
...
**Default:** *contact\_area* = overlap, *area\_correction* = *off*
