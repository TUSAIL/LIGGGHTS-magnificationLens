...
* style = *peri/pmb* or *peri/lps* or *peri/ves*
...
is described in :ref:`(Mitchell) <Mitchell>`.  An additional PDF doc with
details is in `doc/PDF/PDLammps\_VES.pdf <PDF/PDLammps_VES.pdf>`_.  For
...
and s00 and alpha are used as a bond breaking criteria. m\_lambdai and
m\_taubi are the viscoelastic relaxation parameter and time constant,
