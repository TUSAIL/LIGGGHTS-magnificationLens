pair\_style meam/spline
=======================

pair\_style meam/spline/omp
===========================
...
.. warning::
   ...
   The *meam/spline* style currently supports only
...
:doc:`pair\_coeff <pair_coeff>`, :doc:`pair\_style meam <pair_meam>`
