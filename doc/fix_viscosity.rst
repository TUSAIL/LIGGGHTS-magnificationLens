...
.. warning::
   ...
   If your system is periodic in the direction of the
...
.. warning::
   ...
   After equilibration, if the velocity profile you
...
simulation, as described in :ref:`Section\_howto 13 <howto_13>` of the manual.  NEMD simulations
deform the simulation box via the :doc:`fix deform <fix_deform>`
