...
either by itself or as a sub-style in a :doc:`pair\_style hybrid or hybrid/overlay <pair_hybrid>` command.
...
:doc:`pair\_style reax <pair_reax>` command.  These values (1 or more)
