.. index:: fix pour/legacy

fix pour/legacy command
=======================
...
.. parsed-literal::
   ...
   fix ID group-ID pour/legacy N type seed keyword values ...

* ID, group-ID are documented in :doc:`fix <fix>` command
* pour/legacy = style name of this fix command
...
.. parsed-literal::
   ...
   fix 3 all pour/legacy 1000 2 29494 region myblock
   fix 2 all pour/legacy 10000 1 19985583 region disk vol 0.33 100 rate 1.0 diam 0.9 1.1
...
specified in the fix pour/legacy command (which can also be "all").
...
produce the same behavior if you adjust the fix pour/legacy parameters
appropriately.
