...
information see also the :doc:`superquadric guide <superquadric_simulations>`.
...
**(Miller, 2002)** `Miller. et al., Journal of Chemical Physics, 116 (20), p 8649-8659 (2002) <http://scitation.aip.org/content/aip/journal/jcp/116/20/10.1063/1.1473654>`_


**(Walton, 1993)** `Walton and Braun, DOE/NSF Workshop on Flow of Particulates and Fluids, p 1-18 (1993) <http://www.grainflow.com/index_files/Rotary_Drum_Simulation_DOE-NSF-1993.pdf>`_
