...
* keyword = *units*
  ...
  .. parsed-literal::
       ...
       *e* value = coefficient of restitution (value between 0 and 1)
...
Specifying the coefficient of restitution results in scaling the 
post-impact velocity by this factor.
...
:doc:`fix wall/lj93 <fix_wall>` command
