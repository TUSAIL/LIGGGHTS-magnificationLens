...
* keyword = *periodic* or *check\_mark\_every*
...
that are in the region specified via the *region\_count* keyword. Particles have
...
See :ref:`this section <howto_15>` for an overview of LAMMPS output
options.
