...
switch; see :ref:`Section\_start 7 <start_7>` of the
...
.. warning::
   ...
   As explained below, a NEB calculation perfoms a
   ...
   :doc:`timestep <timestep>` command.  You may get faster convergence for
...
The "atom\_modify sort 0 0.0" command should be used to turn off atom
sorting.
...
:doc:`timestep <timestep>` to use with NEB.  Using the same timestep
that would be used for a dynamics :doc:`run <run>` of your system is
advised.
...
.. thumbnail:: img/hop1.jpg

.. thumbnail:: img/hop2.jpg
