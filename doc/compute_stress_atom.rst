...
In LIGGGHTS, this command includes stress contributions from
:doc:`granular wall <fix_wall_gran>` contacts.
...
.. warning::
   ...
   For granular systems, this formula neglects the 
...
a compute as input.  See :ref:`Section\_howto 15 <howto_15>` for an overview of LAMMPS output
options.
