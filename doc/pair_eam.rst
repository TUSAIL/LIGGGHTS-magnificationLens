...
pair\_style eam/alloy/cuda command
==================================
...
pair\_style eam/fs/cuda command
===============================
...
.. warning::
   ...
   The *eam* style reads single-element EAM potentials in
...
See :doc:`Section\_accerlate <Section_accelerate>` of the manual for more
