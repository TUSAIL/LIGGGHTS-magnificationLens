...
additional quantities that are only defined for certain :doc:`atom styles <atom_style>`.  Basically, this list gives an input script
...
:doc:`fix property/atom <fix_property>` command.  When that command
...
:doc:`fix property/atom <fix_property>`
