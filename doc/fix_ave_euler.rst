...
* cx = cell size in x-direction in multiples of max cutoff
* cy = cell size in y-direction in multiples of max cutoff
* cz = cell size in z-direction in multiples of max cutoff
...
.. parsed-literal::
   ...
   fix 1 all ave/euler nevery 100 cell_size_relative 4.5 3 3 parallel yes
...
However, it does not include bond, angle, dihedral or kspace contributions
...
stresses near walls that are not aligned with the grid will be
incorrect.
