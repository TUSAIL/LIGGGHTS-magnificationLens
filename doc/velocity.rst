...
deleted when the velocity command is finished.  See the :doc:`compute temp <compute_temp>` command for details.  If the computed
...
:doc:`fix shake <fix_shake>`, :doc:`lattice <lattice>`
