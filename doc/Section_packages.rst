...
| 5.1 :ref:`Standard packages <pkg_1>`
| 5.2 :ref:`User packages <pkg_2>`
|
...
Below, the packages currently available in LAMMPS are listed.  For
...
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| ASPHERE  | aspherical particles          | -                                  | :ref:`Section\_howto <howto_14>`                   | ellipse | -         |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| CLASS2   | class 2 force fields          | -                                  | :doc:`pair\_style lj/class2 <pair_class2>`         | -       | -         |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| COLLOID  | colloidal particles           | -                                  | :doc:`atom\_style colloid <atom_style>`            | colloid | -         |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| DIPOLE   | point dipole particles        | -                                  | :doc:`pair\_style dipole/cut <pair_dipole>`        | dipole  | -         |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| FLD      | Fast Lubrication Dynamics     | Kumar & Bybee & Higdon (1)         | :doc:`pair\_style lubricateU <pair_lubricateU>`    | -       | -         |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| GPU      | GPU-enabled potentials        | Mike Brown (ORNL)                  | :ref:`Section accelerate <acc_6>`                  | gpu     | lib/gpu   |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| GRANULAR | granular systems              | -                                  | :ref:`Section\_howto <howto_6>`                    | pour    | -         |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| KIM      | openKIM potentials            | Smirichinski & Elliot & Tadmor (3) | :doc:`pair\_style kim <pair_kim>`                  | kim     | KIM       |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| KSPACE   | long-range Coulombic solvers  | -                                  | :doc:`kspace\_style <kspace_style>`                | peptide | -         |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| MANYBODY | many-body potentials          | -                                  | :doc:`pair\_style tersoff <pair_tersoff>`          | shear   | -         |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| MEAM     | modified EAM potential        | Greg Wagner (Sandia)               | :doc:`pair\_style meam <pair_meam>`                | meam    | lib/meam  |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| MC       | Monte Carlo options           | -                                  | :doc:`fix gcmc <fix_gcmc>`                         | -       | -         |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| MOLECULE | molecular system force fields | -                                  | :ref:`Section\_howto <howto_3>`                    | peptide | -         |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| OPT      | optimized pair potentials     | Fischer & Richie & Natoli (2)      | :ref:`Section accelerate <acc_4>`                  | -       | -         |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| PERI     | Peridynamics models           | Mike Parks (Sandia)                | :doc:`pair\_style peri <pair_peri>`                | peri    | -         |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| POEMS    | coupled rigid body motion     | Rudra Mukherjee (JPL)              | :doc:`fix poems <fix_poems>`                       | rigid   | lib/poems |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| REAX     | ReaxFF potential              | Aidan Thompson (Sandia)            | :doc:`pair\_style reax <pair_reax>`                | reax    | lib/reax  |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
| REPLICA  | multi-replica methods         | -                                  | :ref:`Section\_howto <howto_5>`                    | tad     | -         |
+----------+-------------------------------+------------------------------------+----------------------------------------------------+---------+-----------+
...
+--------------+---------------------------------+-------------------------------------+------------------------------------------------------+--------------+----------------------+-------------+
| USER-ATC     | atom-to-continuum coupling      | Jones & Templeton & Zimmerman (2)   | :doc:`fix atc <fix_atc>`                             | USER/atc     | `atc <atc_>`_        | lib/atc     |
+--------------+---------------------------------+-------------------------------------+------------------------------------------------------+--------------+----------------------+-------------+
| USER-AWPMD   | wave-packet MD                  | Ilya Valuev (JIHT)                  | :doc:`pair\_style awpmd/cut <pair_awpmd>`            | USER/awpmd   | -                    | lib/awpmd   |
+--------------+---------------------------------+-------------------------------------+------------------------------------------------------+--------------+----------------------+-------------+
| USER-CG-CMM  | coarse-graining model           | Axel Kohlmeyer (Temple U)           | :doc:`pair\_style lj/sdk <pair_sdk>`                 | USER/cg-cmm  | `cg <cg_>`_          | -           |
+--------------+---------------------------------+-------------------------------------+------------------------------------------------------+--------------+----------------------+-------------+
| USER-COLVARS | collective variables            | Fiorin & Henin & Kohlmeyer (3)      | :doc:`fix colvars <fix_colvars>`                     | USER/colvars | `colvars <colvars>`_ | lib/colvars |
+--------------+---------------------------------+-------------------------------------+------------------------------------------------------+--------------+----------------------+-------------+
| USER-CUDA    | NVIDIA GPU styles               | Christian Trott (U Tech Ilmenau)    | :ref:`Section accelerate <acc_7>`                    | USER/cuda    | -                    | lib/cuda    |
+--------------+---------------------------------+-------------------------------------+------------------------------------------------------+--------------+----------------------+-------------+
| USER-EFF     | electron force field            | Andres Jaramillo-Botero (Caltech)   | :doc:`pair\_style eff/cut <pair_eff>`                | USER/eff     | `eff <eff_>`_        | -           |
+--------------+---------------------------------+-------------------------------------+------------------------------------------------------+--------------+----------------------+-------------+
...
+--------------+---------------------------------+-------------------------------------+------------------------------------------------------+--------------+----------------------+-------------+
| USER-OMP     | OpenMP threaded styles          | Axel Kohlmeyer (Temple U)           | :ref:`Section accelerate <acc_5>`                    | -            | -                    | -           |
+--------------+---------------------------------+-------------------------------------+------------------------------------------------------+--------------+----------------------+-------------+
| USER-REAXC   | C version of ReaxFF             | Metin Aktulga (LBNL)                | :doc:`pair\_style reaxc <pair_reax_c>`               | reax         | -                    | -           |
+--------------+---------------------------------+-------------------------------------+------------------------------------------------------+--------------+----------------------+-------------+
...
.. _atc: https://www.lammps.org/pictures.html#atc



.. _cg: https://www.lammps.org/pictures.html#cg



.. _eff: https://www.lammps.org/movies.html#eff



.. _sph: https://www.lammps.org/movies.html#sph
...
See the doc page for the pair\_style awpmd/cut command to get started.
...
* The colvars fix and an interface layer, exchanges information between LAMMPS and the collective variable module.
...
This is the second generation implementation reducing the clutter
of the previous version. For many systems with electrostatics, it will
be faster to use pair\_style hybrid/overlay with lj/sdk and coul/long
...
of the kspace\_style pppm/cg is recommended over regular pppm. For all
...
See the doc page for the pair\_style eff/cut command to get started.
...
The USER-REAXC version of ReaxFF (pair\_style reax/c), implemented in
C, should give identical or very similar results to pair\_style reax,
...
See the doc page for the pair\_style reax/c command for details
...
See the file doc/USER/sph/SPH\_LAMMPS\_userguide.pdf to get started.
