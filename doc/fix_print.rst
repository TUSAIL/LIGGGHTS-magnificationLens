...
* keyword = *file* or *append* or *screen* or *title* or *starttime* or *endtime*
...
The *title* keyword allows specification of the string that will be
printed as the first line of the output file, assuming the *file* or
*append* keyword was used. By default, the title line is as follows:
