...
The *reax/c* style differs from the :doc:`pair\_style reax <pair_reax>`
...
Two examples using *pair\_style reax/c* are provided in the examples/reax
sub-directory, along with corresponding examples for 
:doc:`pair\_style reax <pair_reax>`.
...
.. warning::
   ...
   Currently the reax/c pair style cannot be used as part
...
write\_freq: Frequency of writes into the trajectory file. (default value = 0)

traj\_title: Title of the trajectory - not the name of the trajectory file.
...
:doc:`pair\_coeff <pair_coeff>`, :doc:`fix qeq/reax <fix_qeq_reax>`, :doc:`fix reax/c/bonds <fix_reax_bonds>`, :doc:`fix reax/c/species <fix_reaxc_species>`, :doc:`pair\_style reax <pair_reax>`
