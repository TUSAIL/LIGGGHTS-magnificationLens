...
* value = vx, vy, vz, fx, fy, fz, density/mass, density/number, c\_ID, c\_ID[I], f\_ID, f\_ID[I], v\_name
...
* keyword = *norm* or *units* or *file* or *ave* or *overwrite* or *title1* or *title2* or *title3* or *std*
...
resulting bin averages can be used by other :ref:`output commands <howto_15>` such as :doc:`thermo\_style custom <thermo_style>`, and can also be written to a file.
...
Note that other atom attributes (including atom positions x,y,z) can
