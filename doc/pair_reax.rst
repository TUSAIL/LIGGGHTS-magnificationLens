.. index:: pair\_style reax

pair\_style reax command
========================
...
The *reax* style differs from the :doc:`pair\_style reax/c <pair_reax_c>`
...
filename is required as an argument in the pair\_coeff command. Any
...
.. warning::
   ...
   We do not distribute a wide variety of ReaxFF force
...
Duin.  We have tested the accuracy of *pair\_style reax* potential
...
Two examples using *pair\_style reax* are provided in the examples/reax
sub-directory, along with corresponding examples for 
:doc:`pair\_style reax/c <pair_reax_c>`.

Use of this pair style requires that a charge be defined for every
atom since the *reax* pair style performs a charge equilibration (QEq)
calculation.  See the :doc:`atom\_style <atom_style>` and
...
Only a single pair\_coeff command is used with the *reax* style which
...
.. warning::
   ...
   Currently the reax pair style cannot be used as part
...
:doc:`pair\_coeff <pair_coeff>`, :doc:`pair\_style reax/c <pair_reax_c>`,
:doc:`fix\_reax\_bonds <fix_reax_bonds>`
