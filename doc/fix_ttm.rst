...
:ref:`(Duffy) <Duffy>` used a tanh() functional form for the temperature
...
their velocities.  Thus a time integration fix (e.g. :doc:`fix nve <fix_nve>`) should still be used to time integrate the affected
...
.. warning::
   ...
   The current implementation creates a copy of the
...
simulation boxes.  You must use periodic :doc:`boundary <boundary>`
