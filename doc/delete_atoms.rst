...
* style = *group* or *region* or *overlap* or *porosity* or *group\_directional*
  ...
  .. parsed-literal::
       ...
       *group_directional* args = group-ID direction target_mass stepsize
         direction = *-x* or *+x* or *-y* or *+y* or *-z* or *+z*
         target_mass = remove as many particles such that the remaining group mass equals the target value
         stepsize = step size how group is seperated into particles to be removed and to remain
...
.. parsed-literal::
   ...
   delete_atoms group_directional edge direction +z target_mass 5.0 stepsize 0.01
...
For style *group\_directional*, particles are removed in the specified
direction until the target mass is reached. E.g. for direction *-x*\ ,
starting from the particle with the largest x coordinate, particles are
...
:doc:`pair style <pair_style>` with force cutoffs greater than or equal
