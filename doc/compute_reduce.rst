...
compute can be accessed by the :doc:`thermo\_style custom <thermo_style>`
command with :doc:`thermo\_modify norm yes <thermo_modify>` set as an
option.  Or it can be accessed by a :doc:`variable <variable>` that
...
compute as input.  See :ref:`Section\_howto 15 <howto_15>`
