...
pair\_style born/coul/long/cuda command
=======================================
...
same global Coulombic cutoff specified in the pair\_style command.
...
:doc:`pair\_modify <pair_modify>` table option ti tabulate the
