...
fix.  See the :doc:`fix property/atom <fix_property>` command for
...
* cs\_re,cs\_im = real/imaginary parts of wavepacket coefficients
...
is given as an argument to the :doc:`atom\_style body <atom_style>`
command.
