...
by use of the :doc:`communicate cutoff <communicate>` command.  Note
...
.. warning::
   ...
   Excluding pairwise interactions will not work
...
.. warning::
   ...
   LAMMPS can crash without an error message if the
