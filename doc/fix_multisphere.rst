...
equivalent to :doc:`fix\_rigid <fix_rigid>`. However, the following 
...
No information about this fix is written to :doc:`binary restart files <restart>`.  This means you can currently not restart a simulation
...
this fix for access by various :ref:`output commands <howto_15>`.  No parameter of this fix can be
