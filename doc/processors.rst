...
.. warning::
   ...
   Unlike the *twolevel* style, the *numa* style does not
...
.. warning::
   ...
   If you use the :doc:`partition <partition>` command to
   invoke different "processors" commands on different partitions, and
