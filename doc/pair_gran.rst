...
.. parsed-literal::
   ...
   pair_style model_type model_name model_keyword model_value
...
* following the model\_type/model\_name pairs, zero or more model\_keyword/model\_value pairs may be appended in arbitrary order
...
damping coefficients k\_n, k\_t, gamma\_n, gamma\_t can now be derived from the material 
