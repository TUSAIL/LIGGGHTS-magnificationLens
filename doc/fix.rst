...
* :doc:`pour/legacy <fix_pour>` - pour new atoms into a granular simulation domain
...
* :doc:`property/atom <fix_property>` - add customized per-atom values
...
* :doc:`rigid <fix_rigid>` - constrain many small clusters of atoms to      move as a rigid body with NVE integration
...
the individual styles are given in the fix section of :ref:`this page <cmd_5>`.
