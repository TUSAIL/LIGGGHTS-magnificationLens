...
See :ref:`Section\_howto 12 <howto_12>` of the doc pages
...
.. warning::
   ...
   Unlike the earlier "displace\_box" version of this
...
orthogonal or triclinic (non-orthogonal).  See :ref:`this section <howto_13>` for a discussion of how non-orthogonal
...
change\_box command is issued, so long as an :doc:`undump <undump>` or
