...
simpler entities that body particles.  See :ref:`Section\_howto 14 <howto_14>` for a general overview of all these
particle types.
...
We hope to add more styles in the future.  See :ref:`Section\_modify 12 <mod_12>` for details on how to add a new body
style to the code.
...
:doc:`read\_data <read_data>` command for details.  The 6 moments of
...
The :doc:`pair\_style body <pair_body>` command can be used with this
