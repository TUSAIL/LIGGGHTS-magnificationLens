...
* general\_keywords general\_values are documented in :doc:`compute <compute>`
...
a group of superquadric particles.
See the :doc:`atom\_style <atom_style>` and :doc:`read\_data <read_data>` commands
...
used by any command that uses a global scalar value from a compute as input.
See :ref:`Section How-to discussions 7.15 <howto_15>` for an
