...
switch7\_Section\_start.html#start\_6 when you invoke LAMMPS, or you can
...
enabled if LAMMPS is build with that package. See the :ref:`Making LAMMPS with optional packages <start_3>` section for more info.
